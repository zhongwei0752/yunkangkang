<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_debate_list|template/default/header|template/default/footer', '1386853687', 'template/default/space_debate_list');?><?php $_TPL['titles'] = array('辩论'); ?>
...
<a href="cp.php?ac=debate" class="r_option" target="_blank">发起辩论</a>
</h3>
<?php if($count) { ?>
<ul class="line_list">
...
<h4><a href="space.php?uid=<?=$space['uid']?>&do=debate&id=<?=$value['debate']?>" target="_blank" <?php if($value['magiccolor']) { ?> class="magiccolor<?=$value['magiccolor']?>"<?php } ?>><?=$value['subject']?></a></h4>
<div class="detail">
<?=$value['message1']?>
</div>
</li>
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="indexing">
                   <span><a href="space.php?do=home">首页</a></span>><span>大擂台</span>
                 </div><!-- end -->
                 <div class="bread container_12">
                     <div class="bread_actived grid_1">
                         我的辩论
                     </div>
                     <a href="cp.php?ac=debate" class="btn grid_2">
                      发起辩论
                     </a>
                 </div>	
...
<?php if(is_array($list)) { foreach($list as $value) { ?>
     	 <div class="content_list container_12">
              ...
              <div class="grid_2">
                 <div class="list_test ">
                      <a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['debateid']?>"><h3><?=$value['subject']?></h3></a>
                      ...
                      <p class="action_info" style="margin-top:-4px;">
                       <a href="space.php?uid=<?=$value['uid']?>"> <span style="color:color:#AAAAAA;">发布：<?=$_SN[$value['uid']]?></span></a>
                        <?php if($value['viewnum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['debateid']?>"><span style="color:color:#AAAAAA;">阅读: (<?=$value['viewnum']?>)</span></a><?php } else { ?><span style="color:color:#AAAAAA;">阅读: (0)</span><?php } ?>
                        <?php if(($value['replynum']=$value['obreplynum']+$value['rereplynum'])) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['debateid']?>#comment"><span style="color:color:#AAAAAA;">评论: (<?=$value['replynum']?>)</span></a><?php } else { ?><span>评论:(0)</span><?php } ?><span style="color:color:#AAAAAA;"><?php echo sgmdate('Y-m-d',$value[dateline]); ?></span>
                      </p>
                 </div>
              </div>
         </div><!-- list end -->
...
window.location.href = "space.php?do=debate&view=we&fuid="+fuid;
}
</script>
<?php } ?>
