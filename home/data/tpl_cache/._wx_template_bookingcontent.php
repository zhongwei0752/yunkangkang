<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('./wx/template/bookingcontent', '1396519262', './wx/template/bookingcontent');?><!DOCTYPE html>
<html>
<head>
...
<body>
     <div class="mainbody">
                 ...
                 <div class="listcontentbody">
                     ...
                     <div class="listcon">
                         ...
                         <div class="l1">
                             ...
                             <span class="l1_s2"><?php echo date('Y-m-d H:i',$bookingvalue['starttime']) ?></span>至
                             <span class="l1_s2"><?php echo date('Y-m-d H:i',$bookingvalue['endtime']) ?></span>
                         </div>
                         <div class="l1">
        ...
        <?php if($joinvalue) { ?>
         ...
         <?php } else { ?>
         <?php if($bookingvalue['people']==$bookingvalue['join']) { ?>
         <div class="btnbox" id="reserve">
