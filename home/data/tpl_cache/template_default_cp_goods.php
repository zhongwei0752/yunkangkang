<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_goods|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1388998194', 'template/default/cp_goods');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<a href="javascript:hideMenu();" class="float_del" title="关闭">关闭</a>
<div class="popupmenu_inner">
<form method="post" action="cp.php?ac=goods&op=delete1&id=<?=$id?>&uid=<?=$uid?>&gid=<?=$gid?>&viewuid=<?=$viewuid?>">
<p>确定发货？</p>
<p class="btn_line">
<input type="hidden" name="refer" value="<?=$_SGLOBAL['refer']?>" />
<input type="hidden" name="delete1submit" value="true" />
<input type="submit" name="btnsubmit" value="确定" class="submit" />
</p>
<input type="hidden" name="formhash" value="<?php echo formhash(); ?>" />
</form>
...
<div class="post_list container_12">
                         ...
                         <span class="select_title grid_1">原价&nbsp;&nbsp;:</span>
                           ...
                           <div class="post_list container_12">
                           <span class="select_title grid_1">优惠价&nbsp;&nbsp;:</span>
                           <input type="text" class="t_input"  id="curprice" name="curprice" value="<?=$goods['curprice']?>" style = "margin-left:20px;"/>
                            </div>
                            <div class="post_list container_12">
                         <span class="select_title grid_1" style="padding-right:20px;">是否在微信列表页显示价格&nbsp;&nbsp;:</span>
                           是:<input type="radio" class="t_input" id="listshow" name="listshow" value="1"   style = "margin-left:20px;padding-right:20px;" <?php if($goods['listshow']!='0') { ?>CHECKED<?php } ?>/>
                            否:<input type="radio" class="t_input" id="listshow"    name="listshow" value="0"   style = "margin-left:20px;" <?php if($goods['listshow']=='0') { ?>CHECKED<?php } ?>/>
                            </div>
                            <div class="post_list container_12">
                         <span class="select_title grid_1">淘宝链接&nbsp;&nbsp;:</span>
                           <input type="text" class="t_input" id="taobaourl" name="taobaourl" value="<?=$goods['taobaourl']?>"  onblur="relatekw();" placeholder="注意输入有效的url" style = "margin-left:20px;"/>
                             ...
                             <div class="post_list container_12">
                         <span class="select_title grid_1">查看购买者信息密码&nbsp;&nbsp;:</span>
                           <input type="text" class="t_input" id="password" name="password" value="<?=$goods['password']?>"  onblur="relatekw();" placeholder="查看购买者信息密码" style = "margin-left:20px;"/>
                            </div>

                            <div class="post_list container_12">
                         <span class="select_title grid_1" style = "margin-right:20px;">推送者&nbsp;&nbsp;:</span>
                           <!-- <input type="text" class="t_input" id="taobaourl" name="taobaourl" value="<?=$goods['taobaourl']?>"  onblur="relatekw();" placeholder="注意输入有效的url" style = "margin-left:20px;"/> -->
                           <select  name="push" >
                           <?php if($goods['push']) { ?>
                           <option value="<?=$goods['fakeid']?>"><?=$goods['name']?></option>
                           <?php } ?>
                           <option value="0">未选择</option>
                           <?php if(is_array($list)) { foreach($list as $value) { ?>
                           <option value="<?=$value['fakeid']?>"><?=$value['name']?></option>
                           <?php } } ?>
                           </select><span style="color:red">(以下2项两者选一进行填写，若2项都填写，默认选择第一项)</span><br/>
                           <span style="margin-left:175px;">or</span><br/>
                           <div style="margin-left:175px;">
                           <input type="text"  class="t_input" id="subject1" autocomplete = "off" name="subject1"   size="40" />
                            <div class="list_box" style="border:1px solid #999;width:257px;">
...
<input type="hidden" name="push1" id="push1">
                         ...
                         <span class="select_title grid_1" style="padding-right:20px;">货到付款功能&nbsp;&nbsp;:</span>
                           开启:<input type="radio" class="t_input" id="goodscod" name="goodscod" value="1"   style = "margin-left:20px;padding-right:20px;" <?php if($goods['goodscod']=='1') { ?>CHECKED<?php } ?>/>
                            关闭:<input type="radio" class="t_input" id="goodscod"    name="goodscod" value="0"   style = "margin-left:20px;" <?php if($goods['goodscod']!='1') { ?>CHECKED<?php } ?>/>
                            </div>
