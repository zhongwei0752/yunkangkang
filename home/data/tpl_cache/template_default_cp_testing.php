<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_testing|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1396585536', 'template/default/cp_testing');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<form method="post" action="cp.php?ac=booking&op=delete&bookingid=<?=$bookingid?>">
<p>确定删除指定的栏目吗？</p>
<p class="btn_line">
...
<a href="javascript:hideMenu();" class="float_del" title="关闭">关闭</a>
<div class="popupmenu_inner">
<form method="post" action="cp.php?ac=booking&op=edithot&bookingid=<?=$bookingid?>">
<p class="btn_line">
新的热度：<input type="text" name="hot" value="<?=$booking['hot']?>" size="5"> 
<input type="hidden" name="refer" value="<?=$_SGLOBAL['refer']?>" />
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="indexing">
                 <span><a href="space.php?do=home">首页</a></span>><span><a href="space.php?do=booking&view=me"> <?=$newname['subject']?></a></span>><span>发布</span>
                 </div><!-- end -->
                 <div class="bread container_12">
                     <div class="bread_actived grid_1">
                         发布
                     </div>
                     <a href="space.php?do=booking&view=me" class="link_back_bread grid_3">
                       <?=$newname['subject']?>
                     </a>
                 </div>
<?php } ?>
...
<form method="post" action="cp.php?ac=booking&bookingid=<?=$booking['bookingid']?>" enctype="multipart/form-data">
...
<?php if($value['classid'] == $booking['classid']) { ?>
<option value="<?=$value['classid']?>" selected><?=$value['classname']?></a></option>
<?php } else { ?>
<option value="<?=$value['classid']?>"><?=$value['classname']?></option>
<?php } ?>
<?php } } ?>
<?php if(!$booking['uid'] || $booking['uid']==$_SGLOBAL['supe_uid']) { ?><option value="addoption" style="color:red;">+新建分类</option><?php } ?>
</select>
                      </div> -->
<div class="post_list container_12">
                         <span class="select_title grid_1">测试标题&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                           <input type="text" class="t_input" id="subject" name="subject" value="<?=$booking['subject']?>" size="40" onblur="relatekw();" placeholder="标题长度不超过80字符" />
                            </div>
                   <!--  <div class="post_list container_12">
                         <span class="select_title grid_1">预约时间&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                         <script type="text/javascript" src="source/script_calendar.js" charset="<?=$_SC['charset']?>"></script>
                   							<input type="text" class="t_input" name="starttime" id="starttime" value="{eval echo sgmdate('Y-m-d H:i', <?=$booking['starttime']?>)}"  onclick="showcalendar(event,this,1,'{eval echo sgmdate('Y-m-d H:i', <?=$_SGLOBAL['timestamp']?>)}', '{eval echo sgmdate('Y-m-d H:i', <?=$_SGLOBAL['timestamp']?> + 3600 * 24 * 60)}')" />
                   						    至
                   							<input type="text" class="t_input" name="endtime" id="endtime" value="{eval echo sgmdate('Y-m-d H:i', <?=$booking['endtime']?>)}"  onclick="showcalendar(event,this,1,'{eval echo sgmdate('Y-m-d H:i', <?=$_SGLOBAL['timestamp']?>)}', '{eval echo sgmdate('Y-m-d H:i', <?=$_SGLOBAL['timestamp']?> + 3600 * 24 * 60)}')" />
                           </div> -->
                  
                           <!--  <div class="post_list container_12">        
                                                    <span class="select_title grid_1">摘要&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                                                    <input type="text" class="t_input" id="tag" name="tag" size="40" value="<?=$booking['tag']?>" placeholder="摘要可自己填写，也会自动获取！"> <input type="button" name="clickbutton[]" value="自动获取" class="button" onclick="relatekw();"  ><br/>
                           </div>
                           <div class="post_list container_12">
                                                    <span class="select_title grid_1">封面图片&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                                                     <input type="file" name="files"  value="<?=$booking['image1url']?>"/>
                           </div> -->
</td>
...
<td>
 <div class="post_list container_12">
                         <span class="select_title grid_1">测试说明<?=$newname['subject']?>&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                          <a id="doodleBox" href="magic.php?mid=doodle&showid=booking_doodle&target=uchome-ttHtmlEditor&from=editor" style="display:none"></a>
  <textarea class="userData" name="message" id="uchome-ttHtmlEditor" style="height:100%;width:100%;display:none;border:0px"><?=$booking['message']?></textarea>
...
<td>
<div class="post_list container_12">        
              <span class="select_title grid_1">问题1&nbsp;&nbsp;:&nbsp;&nbsp;</span>
              <input type="text" class="t_input" id="tag" name="question1" size="80" value="<?=$booking['tag']?>" placeholder="请填写问题！"><br/>
            </div>
<div class="post_list container_12">        
              <span class="select_title grid_1">A&nbsp;&nbsp;:&nbsp;&nbsp;</span>
              <input type="text" class="t_input" id="tag" name="question1A" size="40" value="<?=$booking['tag']?>" placeholder="请填写选项！">&nbsp;&nbsp;分数&nbsp;&nbsp;:&nbsp;&nbsp; <input type="text" name="clickbutton[]" placeholder="分数" class="t_input"  ><br/>
            </div>
           
            <div class="post_list container_12">        
              <span class="select_title grid_1">B&nbsp;&nbsp;:&nbsp;&nbsp;</span>
              <input type="text" class="t_input" id="tag" name="question1B" size="40" value="<?=$booking['tag']?>" placeholder="请填写选项！">&nbsp;&nbsp;分数&nbsp;&nbsp;:&nbsp;&nbsp; <input type="text" name="clickbutton[]" placeholder="分数" class="t_input"  ><br/>
            </div>
            <div class="post_list container_12">        
              <span class="select_title grid_1">C&nbsp;&nbsp;:&nbsp;&nbsp;</span>
              <input type="text" class="t_input" id="tag" name="question1C" size="40" value="<?=$booking['tag']?>" placeholder="请填写选项！">&nbsp;&nbsp;分数&nbsp;&nbsp;:&nbsp;&nbsp; <input type="text" name="clickbutton[]" placeholder="分数" class="t_input"  ><br/>
            </div>
            <div class="post_list container_12">        
              <span class="select_title grid_1">D&nbsp;&nbsp;:&nbsp;&nbsp;</span>
              <input type="text" class="t_input" id="tag" name="question1D" size="40" value="<?=$booking['tag']?>" placeholder="请填写选项！">&nbsp;&nbsp;分数&nbsp;&nbsp;:&nbsp;&nbsp; <input type="text" name="clickbutton[]" placeholder="分数" class="t_input"  ><br/>
            </div>
            </td>
            </tr>
            <tr>
            ...
            <td>
            <div class="post_list container_12">
            <a class="select_title grid_1" id="moretip" href="javascript:" onclick="showMoreOption();" onfocus="this.blur();">增加更多问题</a>
            </div>
</td>
</tr>
...
<input type="button" id="bookingbutton" name="bookingbutton" value="提交发布" onclick="validate(this);" style="display: none;" />
...
<?php if(!$_SGLOBAL['inajax'] && (!$booking['uid'] || $booking['uid']==$_SGLOBAL['supe_uid'])) { ?>
...
<div class="confirm_btn container_12" style="margin-left:-20px;">
                           ...
                           <input type="button" class="btn grid_2" id="issuance" onclick="document.getElementById('bookingbutton').click();" value="保存发布" class="submit" />
...
if(maxnum==5)
{
TextBoxParent.innerHTML +="<div class='post_list container_12'><span class='select_title grid_1'>不能再添加候选项了！</span>";
$("moretip").style.display='none';
return;
}
maxnum = maxnum +1;
//alert(maxnum);
TextBoxParent.innerHTML +="<div class='post_list container_12'><span class='select_title grid_1'>问题"+maxnum+"&nbsp;&nbsp;:&nbsp;&nbsp;</span><input type='text' class='t_input' id='tag' name='question"+maxnum+"' size='80' placeholder='请填写问题！'><br></div><div class='post_list container_12'><span class='select_title grid_1'>A&nbsp;&nbsp;:&nbsp;&nbsp;</span><input type='text' class='t_input' id='question"+maxnum+"A' name='question"+maxnum+"A' size='40 value='<?=$booking['tag']?>' placeholder='请填写选项！'>&nbsp;&nbsp;分数&nbsp;&nbsp;:&nbsp;&nbsp; <input type='text' name='clickbutton[]' placeholder='分数' class='t_input' ><br/></div><div class='post_list container_12'><span class='select_title grid_1'>B&nbsp;&nbsp;:&nbsp;&nbsp;</span><input type='text' class='t_input' id='question"+maxnum+"B' name='question"+maxnum+"B' size='40 value='<?=$booking['tag']?>' placeholder='请填写选项！'>&nbsp;&nbsp;分数&nbsp;&nbsp;:&nbsp;&nbsp; <input type='text' name='clickbutton[]' placeholder='分数' class='t_input' ><br/></div><div class='post_list container_12'><span class='select_title grid_1'>C&nbsp;&nbsp;:&nbsp;&nbsp;</span><input type='text' class='t_input' id='question"+maxnum+"C' name='question"+maxnum+"C' size='40 value='<?=$booking['tag']?>' placeholder='请填写选项！'>&nbsp;&nbsp;分数&nbsp;&nbsp;:&nbsp;&nbsp; <input type='text' name='clickbutton[]' placeholder='分数' class='t_input' ><br/></div><div class='post_list container_12'><span class='select_title grid_1'>D&nbsp;&nbsp;:&nbsp;&nbsp;</span><input type='text' class='t_input' id='question"+maxnum+"D' name='question"+maxnum+"D' size='40 value='<?=$booking['tag']?>' placeholder='请填写选项！'>&nbsp;&nbsp;分数&nbsp;&nbsp;:&nbsp;&nbsp; <input type='text' name='clickbutton[]' placeholder='分数' class='t_input' ><br/></div>";
}
</script><?php ob_out();?>