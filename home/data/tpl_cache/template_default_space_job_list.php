<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_job_list|template/default/header|template/default/footer', '1387276051', 'template/default/space_job_list');?><?php $_TPL['titles'] = array($newname[subject]); ?>
...
<a href="cp.php?ac=job" class="r_option" target="_blank">发布</a>
</h3>
<?php if($count) { ?>
<ul class="line_list">
...
<h4><a href="space.php?uid=<?=$space['uid']?>&do=job&id=<?=$value['jobid']?>" target="_blank" <?php if($value['magiccolor']) { ?> class="magiccolor<?=$value['magiccolor']?>"<?php } ?>><?=$value['subject']?></a></h4>
<div class="detail">
<?=$value['message']?>
</div>
</li>
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="bread container_12">
                     ...
                     <a href="cp.php?ac=job" class="btn grid_2">
                      发布
                     </a>
                 </div>	
                          ...
                          <div class="grid_2_advertise">
                             <div class="list_test ">
                                  ...
                                  <p class="action_info">
                                    ...
                                    <?php if($value['viewnum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['jobid']?>"><span>阅读: (<?=$value['viewnum']?>)</span></a><?php } else { ?><span>阅读: (0)</span><?php } ?><span><?php echo sgmdate('Y-m-d',$value[dateline]); ?></span>
                                  </p>
                             </div>
                          </div>
                     </div><!-- list end -->
...
window.location.href = "space.php?do=job&view=we&fuid="+fuid;
}
</script>
<?php } ?>
