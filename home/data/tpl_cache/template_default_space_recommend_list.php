<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_recommend_list|template/default/header|template/default/footer', '1387336654', 'template/default/space_recommend_list');?><?php $_TPL['titles'] = array('焦点推荐'); ?>
...
<a href="cp.php?ac=recommend" class="r_option" target="_blank">发布</a>
</h3>
<?php if($count) { ?>
<ul class="line_list">
...
<h4><a href="space.php?uid=<?=$space['uid']?>&do=recommend&id=<?=$value['recommendid']?>" target="_blank" <?php if($value['magiccolor']) { ?> class="magiccolor<?=$value['magiccolor']?>"<?php } ?>><?=$value['subject']?></a></h4>
<div class="detail">
<?=$value['message']?>
</div>
</li>
...
<?php } else { ?>
<div class="c_form">还没有相关的焦点推荐。</div>
<?php } ?>
</div>
<?php } else { ?>
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="indexing">
                 <span><a href="space.php?do=home">首页</a></span>><span>焦点推荐</span>
                 </div><!-- end -->
                 <div class="bread container_12">
                     <div class="bread_actived grid_1">
                         焦点推荐
                     </div>
                     <a href="cp.php?ac=recommend" class="btn grid_2">
                      发布
                     </a>
                 </div>	
...
<?php if(is_array($list)) { foreach($list as $value) { ?>
                     <div class="content_list container_12">
                          ...
                          <div class="grid_2">
                             <div class="list_test ">
                                  <a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['recommendid']?>"><h3><?=$value['subject']?><span class="r_option">序号:<?=$value['recommendnum']?></span></h3></a>

                                  <p><?=$value['message']?></p><br/>
                                  <p class="action_info" style="margin-top:-4px;">
                                   <a href="space.php?uid=<?=$value['uid']?>"> <span>发布：<?=$_SN[$value['uid']]?></span></a>
                                    <?php if($value['viewnum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['recommendid']?>"><span>阅读: (<?=$value['viewnum']?>)</span></a><?php } else { ?><span>阅读: (0)</span><?php } ?>
                                    <?php if($value['replynum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['recommendid']?>#comment"><span>评论: (<?=$value['replynum']?> )</span></a><?php } else { ?><span>评论: (0)</span><?php } ?><span><?php echo sgmdate('Y-m-d',$value[dateline]); ?></span>
                                  </p>
                             </div>
                          </div>
                     </div><!-- list end -->
...
window.location.href = "space.php?do=recommend&view=we&fuid="+fuid;
}
</script>
<?php } ?>
