<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_dial|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1387333901', 'template/default/cp_dial');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<form method="post" action="cp.php?ac=dial&op=delete&dialid=<?=$dialid?>">
<p>确定删除指定的栏目吗？</p>
<p class="btn_line">
...
<a href="javascript:hideMenu();" class="float_del" title="关闭">关闭</a>
<div class="popupmenu_inner">
<form method="post" action="cp.php?ac=dial&op=edithot&dialid=<?=$dialid?>">
<p class="btn_line">
新的热度：<input type="text" name="hot" value="<?=$dial['hot']?>" size="5"> 
<input type="hidden" name="refer" value="<?=$_SGLOBAL['refer']?>" />
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="indexing">
                 <span><a href="space.php?do=home">首页</a></span>><span><a href="space.php?do=dial&view=me"> <?=$newname['subject']?></a></span>><span>发布</span>
                 </div><!-- end -->
                 <div class="bread container_12">
                     <div class="bread_actived grid_1">
                         发布
                     </div>
                     <a href="space.php?do=dial&view=me" class="link_back_bread grid_3">
                       <?=$newname['subject']?>
                     </a>
                 </div>
<?php } ?>
...
<form method="post" action="cp.php?ac=dial&dialid=<?=$dial['dialid']?>" enctype="multipart/form-data">
<table cellspacing="4" cellpadding="4" width="100%" class="infotable">
<tr>
<td>
<div class="post_list container_12">
                         <span class="select_title grid_1">名称&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                         <input type="text" class="t_input" id="subject" name="subject" value="<?=$dial['subject']?>" size="40" onblur="relatekw();"  />
                            </div>
                            <div class="post_list container_12">
                         <span class="select_title grid_1">管理员密码&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                         <input type="text" class="t_input" id="password" name="password" value="<?=$dial['password']?>" size="40" onblur="relatekw();"  />
                            </div>
                             <div class="post_list container_12">
                         <span class="select_title grid_1">一等奖&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                          <input type="text" class="t_input" id="fristprice" size="40" name="fristprice" placeholder="奖品" value="<?=$dial['fristprice']?>" />
                         
                            </div>
                            <div class="post_list container_12">
                         <span class="select_title grid_1">一等奖概率&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                        <input type="text" class="t_input" id="fristrand" size="10" name="fristrand" placeholder="概率" value="<?=$dial['fristrand']?>" />/ 
                          <select name="frequencynum">
                         ...
                         <option value="1000000">1000000</option>
                             ...
                             <div class="post_list container_12">
                         <span class="select_title grid_1">二等奖&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                          <input type="text" class="t_input" id="secondprice" size="40" name="secondprice" placeholder="奖品" value="<?=$dial['secondprice']?>" />
                          
                            </div>
                            <div class="post_list container_12">
                         <span class="select_title grid_1">二等奖概率&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                          <input type="text" class="t_input" id="secondrand" size="10" name="secondrand" placeholder="概率" value="<?=$dial['secondrand']?>" />/
                          <select name="frequencynum">
                         <option value="100">100</option>
                         <option value="1000">1000</option>
                         <option value="10000">10000</option>
                         ...
                         <option value="1000000">1000000</option>
                             ...
                             <div class="post_list container_12">
                         <span class="select_title grid_1">三等奖&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                          <input type="text" class="t_input" id="thirdprice" size="40" name="thirdprice" placeholder="奖品" value="<?=$dial['thirdprice']?>" />
                          
                            </div>
                            <div class="post_list container_12">
                         <span class="select_title grid_1">三等奖概率&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                         <input type="text" class="t_input" id="thirdrand" size="10" name="thirdrand" placeholder="概率" value="<?=$dial['thirdrand']?>" />/
                          <select name="frequencynum">
                         <option value="100">100</option>
                         <option value="1000">1000</option>
                         <option value="10000">10000</option>
                         ...
                         <option value="1000000">1000000</option>
                            ...
                            <span style="margin-left:70px;color:red;">*请注意要将一等，二等，三等的概率分母设置为相同的值。即一等奖概率选了1000，那么后两个概率都要为1000.<br/>
                            <br/><br/></span>
                         <!--    <div class="post_list container_12">
                         <span class="select_title grid_1">参与频率&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                         <select name="frequency">
                         <option value="<?=$dial['frequency']?>"></option>
                         <option value="1">仅一次</option>
                         <option value="2">每日一次</option>
                         <option value="3">每日二次</option>
                         <option value="4">每日三次</option>
                         <option value="5">不限制</option>
                         </select>
                            </div> -->
                         <div class="post_list container_12">
                         <span class="select_title grid_1">详细介绍&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                          <a id="doodleBox" href="magic.php?mid=doodle&showid=dial_doodle&target=uchome-ttHtmlEditor&from=editor" style="display:none"></a>
  <textarea class="userData" name="message" id="uchome-ttHtmlEditor" style="height:100%;width:100%;display:none;border:0px"><?=$dial['message']?></textarea>
  <iframe src="editor.php?charset=<?=$_SC['charset']?>&allowhtml=<?=$allowhtml?>&doodle=<?php if(isset($_SGLOBAL['magic']['doodle'])) { ?>1<?php } ?>" name="uchome-ifrHtmlEditor" id="uchome-ifrHtmlEditor" scrolling="no" border="0" frameborder="0" style="width:550px;border: 1px solid #C5C5C5;" height="200"></iframe>
                            </div>

                          
</table>

<input type="hidden" name="dialsubmit" value="true" />
<input type="button" id="dialbutton" name="dialbutton" value="提交发布" onclick="validate(this);" style="display: none;" />
...
<?php if(!$_SGLOBAL['inajax'] && (!$dial['uid'] || $dial['uid']==$_SGLOBAL['supe_uid'])) { ?>
...
<div class="confirm_btn container_12" style="margin-left:-20px;">
                           ...
                           <input type="button" class="btn grid_2" id="issuance" onclick="document.getElementById('dialbutton').click();" value="保存发布" class="submit" />
