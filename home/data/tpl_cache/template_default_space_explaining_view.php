<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_explaining_view', '1396518859', 'template/default/space_explaining_view');?><!DOCTYPE html>
<html>
<head>
                 ...
                 <div class="listcontentbody">
                     ...
                     <div class="listcon">
                         ...
                         <div class="l1">
                             ...
                             <span class="l1_s2"><?php echo date('Y-m-d H:i',$explainingvalue['starttime']) ?></span>
                             <span class="l1_s2"><?php echo date('Y-m-d H:i',$explainingvalue['starttime']) ?></span>
                         </div>
                         <div class="l1">
...
<?php } ?>
 ...
 function ChangeContact(id)
 {
  $.ajax({
                ...
                data: "id="+id+"&explaining=1",//提交表单，相当于CheckCorpID.ashx?ID=XXX
                async: true,
    ...
    function getContact(page,perpage){
        ...
        $.ajax({
                ...
                type: "POST",
                url: "space.php?do=explain",
                data: "page="+page+"&perpage="+perpage+"&getpage=1&explaining=1",//提交表单，相当于CheckCorpID.ashx?ID=XXX
                async: true,
