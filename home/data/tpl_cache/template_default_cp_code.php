<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_code|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1385545989', 'template/default/cp_code');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<?php if(!$_SGLOBAL['inajax'] && (!$code['uid'] || $code['uid']==$_SGLOBAL['supe_uid'])) { ?>
