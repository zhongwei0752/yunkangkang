<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('./wx/template/explaining_success', '1396510577', './wx/template/explaining_success');?><!DOCTYPE html>
<html>
<head>
...
<body>
     <div class="mainbody">
        ...
        <form action="wx.php?do=upload" method="POST">
         <div class="btnbox">
            <input type="submit" name="explainingcancel" value="取消预约">
