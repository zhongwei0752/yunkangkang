<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_code_list|template/default/header|template/default/footer', '1385545988', 'template/default/space_code_list');?><?php $_TPL['titles'] = array($newname[subject]); ?>
...
<a href="cp.php?ac=code" class="r_option" target="_blank">发布</a>
</h3>
<?php if($count) { ?>
<ul class="line_list">
...
<h4><a href="space.php?uid=<?=$space['uid']?>&do=code&id=<?=$value['codeid']?>" target="_blank" <?php if($value['magiccolor']) { ?> class="magiccolor<?=$value['magiccolor']?>"<?php } ?>><?=$value['subject']?></a></h4>
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="bread container_12">
                     ...
                     <a href="cp.php?ac=code" class="btn grid_2">
                      发布
                     </a>
                 </div>		
...
<div class="content_detail_wrapper">
 		<?php if($list) { ?>
<?php if(is_array($list)) { foreach($list as $value) { ?>
                     <div class="content_list container_12" style="margin-left:20px;">
                          <div class="grid_1" >
                          
                          </div>
                          <div class="grid_2">
                             <div class="list_test ">
                                  <a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['codeid']?>"><h3><?=$value['subject']?></h3></a>
                                  <p><?=$value['message']?></p><br/>
                                  <p class="action_info" style="margin-top:-4px;">
                                   <a href="space.php?uid=<?=$value['uid']?>"> <span>发布：<?=$_SN[$value['uid']]?></span></a>
                                    <?php if($value['viewnum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['codeid']?>"><span>阅读: (<?=$value['viewnum']?>)</span></a><?php } else { ?><span>阅读: (0)</span><?php } ?>
                                    <?php if($value['replynum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['codeid']?>#comment"><span>评论: (<?=$value['replynum']?> )</span></a><?php } else { ?><span>评论: (0)</span><?php } ?><span><?php echo sgmdate('Y-m-d',$value[dateline]); ?></span>
                                  </p>
                             </div>
                          </div>
                     </div><!-- list end -->
...
window.location.href = "space.php?do=code&view=we&fuid="+fuid;
}
</script>
<?php } ?>
