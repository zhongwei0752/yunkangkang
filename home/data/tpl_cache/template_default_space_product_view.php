<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_product_view|template/default/header|template/default/space_menu|template/default/space_comment_li|template/default/footer', '1387261199', 'template/default/space_product_view');?><?php $_TPL['titles'] = array($product['subject'], $newname[subject]); ?>
                 ...
                 <div class="content_detail_wrapper">
                      <div class="content_page_detail">
                           ...
                           <div class="feed_action">
                              <ul>
                                 <li>阅览（<?=$product['viewnum']?>）</li>
                                 <li>评论（<?=$product['replynum']?>）</li>
                                 <?php if($_SGLOBAL['supe_uid'] == $product['uid'] || checkperm('manageproduct')) { ?>
                                 <li><a href="cp.php?ac=product&productid=<?=$product['productid']?>&op=edit">修改</a></li>
                                 <li><a href="cp.php?ac=product&productid=<?=$product['productid']?>&op=delete" id="blog_delete_<?=$product['productid']?>" onclick="ajaxmenu(event, this.id)">删除</a></li>
                                 <?php } ?>
                              </ul>
                           </div>
