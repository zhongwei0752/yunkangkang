<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_recommend|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1387336619', 'template/default/cp_recommend');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<form method="post" action="cp.php?ac=recommend&op=delete&recommendid=<?=$recommendid?>">
<p>确定删除指定的栏目吗？</p>
<p class="btn_line">
...
<a href="javascript:hideMenu();" class="float_del" title="关闭">关闭</a>
<div class="popupmenu_inner">
<form method="post" action="cp.php?ac=recommend&op=edithot&recommendid=<?=$recommendid?>">
<p class="btn_line">
新的热度：<input type="text" name="hot" value="<?=$recommend['hot']?>" size="5"> 
<input type="hidden" name="refer" value="<?=$_SGLOBAL['refer']?>" />
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="indexing">
                   <span><a href="space.php?do=home">首页</a></span>><span><a href="space.php?do=recommend&view=me">焦点推荐</a></span>><span>发布</span>
                 </div><!-- end -->
                 <div class="bread container_12">
                     <div class="bread_actived grid_1">
                         发布
                     </div>
                     <a href="space.php?do=recommend&view=me" class="link_back_bread grid_3">
                      焦点推荐
                     </a>
                 </div>
<?php } ?>
...
<form method="post" action="cp.php?ac=recommend&recommendid=<?=$recommend['recommendid']?>" enctype="multipart/form-data">
<table cellspacing="4" cellpadding="4" width="100%" class="infotable">
<tr>
<td>
<div class="post_list container_12">
                         <span class="select_title grid_1">标题&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                           <input type="text" class="t_input" id="subject" name="subject" value="<?=$recommend['subject']?>"  onblur="relatekw();" placeholder="标题长度不超过80字符" />
                            </div>
                            <div class="post_list container_12">
                         <span class="select_title grid_1">推荐海报图&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                          <input type="file" name="files"  value="<?=$recommend['image1url']?>"/>
                            </div>
                              <div class="post_list container_12">
                         <span class="select_title grid_1">推荐链接&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                           <input type="text" class="t_input"  id="recommendlink" name="recommendlink" value="<?=$recommend['recommendlink']?>">
                            </div>
                             <div class="post_list container_12">
                         <span class="select_title grid_1">推荐序号&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                           <input type="text" class="t_input"  id="recommendnum" name="recommendnum" value="<?=$recommend['recommendnum']?>">
                            </div>
</td>
</tr>
<tr>
...
<div class="post_list container_12">
                         <span class="select_title grid_1">详细描述&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                          <a id="doodleBox" href="magic.php?mid=doodle&showid=recommend_doodle&target=uchome-ttHtmlEditor&from=editor" style="display:none"></a>
  <textarea class="userData" name="message" id="uchome-ttHtmlEditor" style="height:100%;width:100%;display:none;border:0px"><?=$recommend['message']?></textarea>
...
<input type="hidden" name="recommendsubmit" value="true" />
<input type="button" id="recommendbutton" name="recommendbutton" value="提交发布" onclick="validate(this);" style="display: none;" />
<input type="hidden" name="topicid" value="<?=$_GET['topicid']?>" />
<input type="hidden" name="formhash" value="<?php echo formhash(); ?>" />
</form>

<?php if(!$_SGLOBAL['inajax'] && (!$recommend['uid'] || $recommend['uid']==$_SGLOBAL['supe_uid'])) { ?>
<table cellspacing="4" cellpadding="4" width="100%" class="infotable">
...
<div class="confirm_btn container_12">
                           ...
                           <input type="button" class="btn grid_2" id="issuance" onclick="document.getElementById('recommendbutton').click();" value="保存发布" class="submit" />
