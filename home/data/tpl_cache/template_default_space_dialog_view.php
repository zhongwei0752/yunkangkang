<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_dialog_view|template/default/header|template/default/footer', '1386217552', 'template/default/space_dialog_view');?>
                          ...
                          <?php if($value['uid'] == $_SGLOBAL['supe_uid']) { ?>
                          	...
                          	<div class="bubbleright">
                				...
                				<div class = "bubble">
                          		...
                          		<div class = "bubblefooter right1"><?php echo sgmdate('Y-m-d H:i:s',$value[dateline]); ?> 
                          ...
                          <?php } else { ?>
                          	...
                          	<div class = "bubble">
                          		...
                          		<div class = "bubblefooter right1">
                          			<?php echo sgmdate('Y-m-d H:i:s',$value[dateline]); ?></div>
                          	</div>
                          	</div>
                          <?php } ?>
                     </div><!-- list end -->
