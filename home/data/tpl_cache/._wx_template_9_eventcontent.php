<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('./wx/template/9/eventcontent', '1387354815', './wx/template/9/eventcontent');?><!DOCTYPE html>
<html>
    <head>
...
<?php } ?>
            ...
            <div class="LookForPhone">
                <span class="LookForPhone_s1">已有3人报名</span>
                  ...
                  async: true,                    
                    success: function (data) {
                      ...
                      $("#buttonBuy").val("你已经成功报名");
                       $('#ajax').append("<li><span style='padding-right:40px;'>"+$('#eventname').val()+"<p style='float:right;'>现在</p><br/></li>");//输出提交的表表单
