<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('./wx/template/8/feedcontent', '1387264928', './wx/template/8/feedcontent');?><!DOCTYPE html>
<html>
<head>
<meta charset = "utf-8" />
...
<ul class = "pageSelect">
<!--	<li><a href = "#" class="colour">上一页</a></li>
<li>1/3</li>
<li><a href = "#" class="colour">下一页</a></li>       -->
</ul>
</div>


            <div id="friend" class="friend_wrapper" style="
                 background-color: #fff;width:99%;height:115px;border:1px dashed #999;margin:0 auto;margin-bottom:30px;text-align:center;">
            ...
            <input style="margin-top: 0px;margin-bottom: 20px;width: 96%;margin-left: 2%;padding-top: 10px;padding-bottom: 10px"
