<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_goods_view|template/default/header|template/default/space_menu|template/default/space_comment_li|template/default/footer', '1389868069', 'template/default/space_goods_view');?><?php $_TPL['titles'] = array($goods['subject'], '商品管理'); ?>
                 ...
                 <div class="content_detail_wrapper">
                      <div class="content_page_detail">
                           ...
                           <div class="title_down container_12">
                                ...
                                <span class="grid_2" style= "font-size: 15px;">分类：<?=$goods['fenlei']?></span>
                               ...
                               <?php if($goods['taobaourl']) { ?>
                               	...
                               	<a href = "space.php?do=goods&uid=<?=$space['uid']?>&cod=1" class="book_btn grid_1" style="margin-right:20px;">货到付款列表</a>
