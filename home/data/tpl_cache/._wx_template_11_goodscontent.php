<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('./wx/template/11/goodscontent', '1386642416', './wx/template/11/goodscontent');?><!DOCTYPE html>
<html>
<head>
<meta charset = "utf-8" />
...
<h3 style="color: #cccccc;"><?=$wei['subject']?></h3>
...
<div class="wrapperPic mb8 mt8"><!--<img src = "img/exam2.jpg" class = "w vb" />--></div>
<div class = "mt10 mb10" style="margin-left: -35px;margin-top: -10px;">
<!--<span class = "ml10 lt">原价：￥ <?=$wei['curprice']?></span>--><span class = "colour ml35">现价：￥ <?=$wei['curprice']?></span>
</div>
                <div class="messagetext"><?=$message?></div>

                <div id="friend" class="friend_wrapper" style="
                background-color: #606060;width:100%;height:115px;border:1px dashed #999;margin:0 auto;margin-top:20px;text-align:center;">
                    ...
                    <div style="margin:0 auto;padding:0;height: 30px;width:100%;text-align: center;margin-top: -50px"> <h3 style="font-size:14px;color: #CCCCCC;">手机用户请关注微信公众账号：<?=$uidwxkey['weixinname']?></h3></div>
                    <?php } ?>
