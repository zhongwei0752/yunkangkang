<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_goods|template/default/header|template/default/footer', '1389869305', 'template/default/space_goods');?><?php $_TPL['titles'] = array('商品管理'); ?>
...
<?php if(!empty($_SGLOBAL['inajax'])) { ?>
 <img src="./template/default/image/book_hover.png" style="position:absolute;top:99999999999999999;"/>
...
<h4><a href="space.php?uid=<?=$space['uid']?>&do=goods&id=<?=$value['goodsid']?>" target="_blank" <?php if($value['magiccolor']) { ?> class="magiccolor<?=$value['magiccolor']?>"<?php } ?>><?=$value['subject']?></a></h4>
<div class="detail">
<?=$value['message']?>
</div>
</li>
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="indexing">
                  <span><a href="space.php?do=home">首页</a></span>><span>商品管理</span>
                 </div><!-- end -->
                 <div class="bread container_12">
                     <div class="bread_actived grid_1">
                         我的商品
                     </div>
                     <a href="space.php?do=goods&view=me&status=sort" class="btn grid_2">
                      排序
                     </a>
                     <a href="cp.php?ac=goods" class="btn grid_2">
                      发布
                     </a>
                 </div>	
...
<?php if(is_array($list)) { foreach($list as $value) { ?>
                     <div class="content_list container_12">
                          ...
                          <div class="grid_2">
                             <div class="mylist">
                                  <a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['goodsid']?>"><h3><?=$value['subject']?></h3></a>
                                  (<a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&status=up&sortid=<?=$value['sort']?>&goodsid=<?=$value['goodsid']?>"><span>上移一位</span></a>
                                  <a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&status=down&sortid=<?=$value['sort']?>&goodsid=<?=$value['goodsid']?>"><span>下移一位</span></a>
                                  <a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&status=top&sortid=<?=$value['sort']?>&goodsid=<?=$value['goodsid']?>"><span>置顶</span></a>
                                  )
                                  <p class = "mes"><?=$value['message']?></p>
                                  <table>
                                  	<tr>
                                   <td style="width:236px;"><a href="space.php?uid=<?=$value['uid']?>"> <span>发布:<?=$_SN[$value['uid']]?>&nbsp;&nbsp;</span></a><?php if($value['fenlei']) { ?><span>分类:<?=$value['fenlei']?></span><?php } ?><br/></td>
                                    <td style="width:86px;"><?php if($value['viewnum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['goodsid']?>"><span>阅读: (<?=$value['viewnum']?>)</span></a><?php } else { ?><span>阅读: (0)</span><?php } ?></td>
                                    <td style="width:56px;"><?php if($value['replynum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['goodsid']?>#comment"><span>评论: (<?=$value['replynum']?> )</span></a><?php } else { ?><span>评论: (0)</span><?php } ?></td><br/>
                             ...
                             <div class = "mybox">
                             	  <table>
                             	  	<tr>
                             	  		<td><span class = "old">原价：<?=$value['oldprice']?></span></td>
                             	  
                             	  	</tr>
                             	  	<tr>
                             	  		<td><span class ="cl">优惠价：<br/><?=$value['curprice']?></span></td>
                             	  	</tr>
                             	  	<tr>
                             	  		<td class = "taobaourl" onclick='gototaobao("<?=$value['taobaourl']?>")'><a herf = "javascript:(void);" >购买</a></td>
                             	  	</tr>
                             	  </table>
                             </div>
