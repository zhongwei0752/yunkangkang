<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('./wx/template/feed', '1396519260', './wx/template/feed');?><!DOCTYPE html>
<html>
<head>
<meta charset = "utf-8" />
...
<span class = "info_span subtitle">{{= dateline}}
<?=BLOCK_TAG_START?>if goodscod<?=BLOCK_TAG_END?>
<?=BLOCK_TAG_START?>if listshow=='1'<?=BLOCK_TAG_END?>
<span style="margin-left:30px;color:red;">￥{{= curprice}}</span>
<?=BLOCK_TAG_START?>/if<?=BLOCK_TAG_END?>
<?=BLOCK_TAG_START?>/if<?=BLOCK_TAG_END?>
...
<?=BLOCK_TAG_START?>if starttime0<?=BLOCK_TAG_END?>
<?=BLOCK_TAG_START?>if time<?=BLOCK_TAG_END?>
<span style="margin-left:30px;color:red;">秒杀未开始</span>
<?=BLOCK_TAG_START?>/if<?=BLOCK_TAG_END?>
<?=BLOCK_TAG_START?>if time1<?=BLOCK_TAG_END?>
<span style="margin-left:30px;color:red;">秒杀进行中</span>
<?=BLOCK_TAG_START?>/if<?=BLOCK_TAG_END?>
<?=BLOCK_TAG_START?>if time2<?=BLOCK_TAG_END?>
<span style="margin-left:30px;color:red;">秒杀已结束</span>
<?=BLOCK_TAG_START?>/if<?=BLOCK_TAG_END?>
<?=BLOCK_TAG_START?>/if<?=BLOCK_TAG_END?>
</span>
                    </div>
