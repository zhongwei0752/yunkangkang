<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_dial_list|template/default/header|template/default/footer', '1389751786', 'template/default/space_dial_list');?><?php $_TPL['titles'] = array($newname[subject]); ?>
...
<a href="cp.php?ac=dial" class="r_option" target="_blank">发布</a>
</h3>
<?php if($count) { ?>
<ul class="line_list">
...
<h4><a href="space.php?uid=<?=$space['uid']?>&do=dial&id=<?=$value['dialid']?>" target="_blank" <?php if($value['magiccolor']) { ?> class="magiccolor<?=$value['magiccolor']?>"<?php } ?>><?=$value['subject']?></a></h4>
<div class="detail">
<?=$value['message']?>
</div>
</li>
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="bread container_12">
                     ...
                     <a href="cp.php?ac=dial" class="btn grid_2">
                      发布
                     </a>
                 </div>	
...
<div class="content_list container_12">
                          ...
                          <div class="grid_2_advertise">
                             <div class="list_test ">
                                  <h3><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['dialid']?>"><?=$value['subject']?> </a></h3><?php if($value['status']=='1') { ?>当前启用<?php } ?>
                                  <a class="r_option" href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['dialid']?>&op=open">启用</a>
                                  <p><?=$value['message']?></p><br/>
                                  <p class="action_info">
                                     <a href="space.php?uid=<?=$value['uid']?>"> <span>发布：<?=$_SN[$value['uid']]?></span></a>
                                    <?php if($value['viewnum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['dialid']?>"><span>阅读: (<?=$value['viewnum']?>)</span></a><?php } else { ?><span>阅读: (0)</span><?php } ?><span><?php echo sgmdate('Y-m-d',$value[dateline]); ?></span>
                                  </p>
                             </div>
                          </div>
                     </div><!-- list end -->
...
window.location.href = "space.php?do=dial&view=we&fuid="+fuid;
}
</script>
<?php } ?>
