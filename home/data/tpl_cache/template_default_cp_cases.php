<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_cases|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1387269707', 'template/default/cp_cases');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<form method="post" action="cp.php?ac=cases&op=delete&casesid=<?=$casesid?>">
<p>确定删除指定的栏目吗？</p>
<p class="btn_line">
...
<a href="javascript:hideMenu();" class="float_del" title="关闭">关闭</a>
<div class="popupmenu_inner">
<form method="post" action="cp.php?ac=cases&op=edithot&casesid=<?=$casesid?>">
<p class="btn_line">
新的热度：<input type="text" name="hot" value="<?=$cases['hot']?>" size="5"> 
<input type="hidden" name="refer" value="<?=$_SGLOBAL['refer']?>" />
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="bread container_12">
                     ...
                     <a href="space.php?do=cases&view=me" class="link_back_bread grid_3">
                      <?=$newname['subject']?>
                     </a>
                 </div>
<?php } ?>
...
<form method="post" action="cp.php?ac=cases&casesid=<?=$cases['casesid']?>" enctype="multipart/form-data">
...
<div class="post_list container_12">
                         ...
                         <span class="select_title grid_1">封面图片&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                           <input type="file" name="files" value="<?=$cases['image1url']?>" />
                            </div>
</td>
</tr>
<tr>
...
<input type="hidden" name="casessubmit" value="true" />
<input type="button" id="casesbutton" name="casesbutton" value="提交发布" onclick="validate(this);" style="display: none;" />
