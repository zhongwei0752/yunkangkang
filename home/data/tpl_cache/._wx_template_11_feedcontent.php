<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('./wx/template/11/feedcontent', '1386642174', './wx/template/11/feedcontent');?><!DOCTYPE html>
<html>
<head>
<meta charset = "utf-8" />
...
<div class = "article p8" style="background-color: #240934;">
                ...
                <div id="detail-panel" style="margin-left: 0px;color:#cccccc ;"></div>
<div class="main-message" style="color:#cccccc ;">  <?=$message?></div>
...
<ul class = "pageSelect">
        ...
        <div class = "wrapperPic h2"><img style="height:4px" src = "./template/11/img/bottom_border.png" class="w h vt" /></div>
              ...
              <div id="friend" class="friend_wrapper" style="
                 background-color: #606060;width:99%;height:115px;border:1px dashed #999;margin:0 auto;margin-bottom:30px;text-align:center;">
        ...
        <input style="margin-top: 0px;margin-bottom: 20px;width: 96%;margin-left: 2%"
         type = "button" id="buttonBook"  class = "dial_btn btn" value = "预定" />
        <?php } ?>
