...
define('CONNECT_ROOT', S_ROOT."/weibo");
...
foreach (array('app', 'userapp', 'ad', 'magic','quiz') as $value) {
...
if(empty($_GET['m_timestamp']) || $_SGLOBAL['mobile'] != md5($_GET['m_timestamp']."\t".$_SCONFIG['sitekey'])) $_SGLOBAL['mobile'] = '1'; // app
