...
function talkcomment_form(doid, id) {
	var showid = 'talkcomment_form_'+doid+'_'+id;
	var divid = 'talkcomment_' + doid;
	ajaxget('cp.php?ac=talk&op=docomment&doid='+doid+'&id='+id, showid);
	if($(divid)) {
		$(divid).style.display = '';
	}
}
