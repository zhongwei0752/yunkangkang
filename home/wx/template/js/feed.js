...
$(document).ready(function(){
  ...
  var status=$.query.get('status');
	$.ajax({
			dataType: "jsonp",
			url: "http://localhost/yunkang/yunkang/home/capi/space.php?do="+idtype+"&uid="+uid+"&status="+status+"&page=1&perpage=10&view=me",
...
if(""+idtype+""=="explaining"){
          data=data.data.explaining;
           if (data.length<=0){
            $(".more_button").appendto("<div class='more_button'>亲，没有了哦！</div>");
          }
}
...
//转发功能
  ...
  $.ajax({
      dataType: "jsonp",
      url: "http://localhost/yunkang/yunkang/home/capi/space.php?do="+idtype+"&uid=" + uid + "&page=" + page + "&perpage=" + perpage +"&view=me",
