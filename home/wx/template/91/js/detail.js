      ...
      /*  data.introduce.dateline = date('Y-m-d H:i',data.introduce.dateline);
        ...
        converter.innerHTML = data.introduce.message;
          ...
          $("#detailTemplate").tmpl(data ).appendTo('#detail-panel');   */
            ...
            data.introduce.dateline = date('Y-m-d',data.introduce.dateline);
          var converter = data.introduce.message;
            converter.innerHTML = data.introduce.message;

          //  $("#detailTemplate").tmpl(data ).appendTo('#detail-panel');
            $("#detailTemplate2").tmpl(data ).appendTo('#time1');
            $("#detailTemplate3").tmpl(data ).appendTo('#cTitle1');
    ...
    $.ajax({
      ...
      success: function( data ) {
        ...
        if(data.code==0){
          ...
          data=data.data;
   ////////////////////////////////////////////////////////////////////////////
          data.goods.dateline = date('Y-m-d',data.goods.dateline);
