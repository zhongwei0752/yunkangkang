...
/*
	...
	$Id: config.yunkang.php 9293 2008-10-30 06:44:42Z liguode $
*/
...
define('UC_DBNAME', 'yunkang'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`yunkang`.uc_'); // UCenter 数据库表前缀
